...
namespace ASC.Model.Queries
{
    public static class Queries
    {
            ...
            string serviceEngineerEmail = "")
        {
            ...
            // Add Requested Date Clause if requestedDate.HasValue
            if (requestedDate.HasValue)
            {
                var requestedDateFilter =
                    (Expression<Func<ServiceRequest, bool>>)(u => u.RequestedDate >= requestedDate);
            ...
            {
                var requestedDateFilter =
                    (Expression<Func<ServiceRequest, bool>>)(u => u.PartitionKey == email);
            ...
            if (status != null)
            {
                ...
                {
                    var statusFilter =
                        (Expression<Func<ServiceRequest, bool>>)(u => u.Status == state);
